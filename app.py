...
class DatabaseApp:
    ...
    def create_header(self):
        ...
        # Logo y título
        ttk.Label(header, text="⚡", font=("Segoe UI", 24)).pack(side=tk.LEFT, padx=10)
        ttk.Label(header, text="Gestión de Clientes", 
                font=("Segoe UI", 16, "bold")).pack(side=tk.LEFT)
        
        # Menú de usuario
        self.user_menu = ttk.Menubutton(header, text="☰", style="Nav.TButton")
