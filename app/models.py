...
class UserDB(Base):
    ...
    # Relationships
    roles = relationship("RoleDB", secondary="pal_usuarios_roles", back_populates="usuarios")
    sesiones = relationship("SessionDB", back_populates="usuario")
    permisos_directos = relationship("UserPermissionDB", back_populates="usuario")
    modulos_habilitados = relationship("UserModuleDB", back_populates="usuario")
...
class RoleDB(Base):
    ...
    # Relationships
    usuarios = relationship("UserDB", secondary="pal_usuarios_roles", back_populates="roles")
...
class UserRoleDB(Base):
    ...
    usuario = relationship("UserDB", back_populates="roles_asignados_rel") # Added relationship for reverse lookup if needed
    rol = relationship("RoleDB", back_populates="usuarios_asignados_rel") # Added relationship for reverse lookup if needed
...
class UserPermissionDB(Base):
    ...
    usuario = relationship("UserDB", back_populates="permisos_directos")
...
class UserModuleDB(Base):
    ...
    usuario = relationship("UserDB", back_populates="modulos_habilitados")
...
class UserUpdateRequest(UserUpdateBase): # Use UserUpdateDB here, or refine if needed
    pass
